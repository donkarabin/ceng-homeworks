...
if __name__ == "__main__":
    receiver_thread_from_s= threading.Thread(target=receiver_func, args= ("10.10.3.2",3002))
    receiver_thread_from_s.start()
    receiver_thread_from_r2= threading.Thread(target=receiver_func, args= ("10.10.6.2",3009))
    receiver_thread_from_r2.start()
    receiver_thread_from_d= threading.Thread(target=receiver_func, args= ("10.10.7.2",3007))
