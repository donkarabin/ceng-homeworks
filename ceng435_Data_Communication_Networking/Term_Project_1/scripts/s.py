...
if __name__ == "__main__":
        sender_thread_to_r1= threading.Thread(target=sender_func, args= ("10.10.1.2",3000,"s-to-r1"))
        sender_thread_to_r1.start()
        sender_thread_to_r2= threading.Thread(target=sender_func, args= ("10.10.2.1",3001,"s-to-r2"))
        sender_thread_to_r2.start()
        sender_thread_to_r3= threading.Thread(target=sender_func, args= ("10.10.3.2",3002,"s-to-r3"))
