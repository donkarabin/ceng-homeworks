...
def main():
    ...
    validation_acc_training=[]
    for k in range(1,199):
        validation_acc_training.append(cross_validation(train_data,train_labels, k,10))
    max_acc_ind=validation_acc_training.index(max(validation_acc_training))+1
    test_acc=knn(train_data,train_labels,test_data,test_labels,max_acc_ind)
    print('Maximum Average Validation Accuracy: ',validation_acc_training[max_acc_ind])
    print('Best K_knn value: ',max_acc_ind)
    print('Test Aaccuracy: ',test_acc)
    mplt.plot(range(1,199), validation_acc_training)
    mplt.xlabel("K_knn values")
    mplt.ylabel("Average Accuracies")
    mplt.show()
